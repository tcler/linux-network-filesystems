...
vm $distro -n nfsclient2 cpus=2 -msize=4000 --kdump -f -p "vim gcc make kernel-devel elfutils-libelf"
...
vm exec nfsclient2 -- /root/nfsv4-open-race/run.sh 192.168.122.1:/nfsshare /mnt/nfs 0x306
