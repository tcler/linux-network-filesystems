...
mkdir -p $resdir
{
  ...
  vmrunx - $vmclnt -- nfstest_delegation --server=$servaddr --export=$expdir --nfsversion=4.2 --client $clntxaddr --client-nfsvers=4.0,4.1,4.2 --trcdelay 3 --createlog --keeptraces --verbose 2 $TESTS;
  stopvms
